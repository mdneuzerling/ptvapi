...
#'
#' This function is designed to parse the content returned by the interior
#' steps of the `routes` function. If geopath data is requested, that content
#' will contain a list of `geopaths` for each route. This function is designed
#' to parse _one_ of those geopaths into a tibble.
#'
#' @param route A `geopaths` object, as a list, as found in the content returned
#'   by the `routes` API call.
#'
#' @return A tibble of routes, with the following columns:
#' \itemize{
#'   \item `direction_id`
